...
The Gini coefficient measures the inequality among the values of a frequency distribution, hence a discrete quantity. It is computed based on the Weighted Sum of the frequencies.
